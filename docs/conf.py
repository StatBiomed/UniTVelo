...
github_repo = 'unitvelo'
github_nb_repo = 'unitvelo'
...
latex_documents = [
  ('index', 'UniTVelo.tex', u'UniTVelo Documentation',
   u'Mingze Gao', 'manual'),
]
...
man_pages = [
    ('index', 'UniTVelo', u'UniTVelo Documentation',
     [u'Mingze Gao'], 1)
]
...
texinfo_documents = [
  ('index', 'UniTVelo', u'UniTVelo Documentation',
   u'Mingze Gao', 'UniTVelo', 'One line description of project.',
   'Miscellaneous'),
]
